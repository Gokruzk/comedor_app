  ...
  return (
      <main className="bg-gray-50 dark:bg-gray-100 min-h-screen">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          <div className="w-full bg-white rounded-3xl shadow-2xl dark:border md:mt-0 sm:max-w-4xl xl:p-0 dark:border-white">
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8 sm:pt-2">
              <form className="space-y-4 md:space-y-6" action={registerUser}>
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 place-content-center">
                  <div>
                    <input
                      type="email"
                      name="correo"
