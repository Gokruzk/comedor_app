  ...
  return (
    <div className="bg-white dark:bg-white border border-gray-200 dark:border-white rounded-lg shadow-2xl p-6">
      ...
      <div className="flex space-x-2">
        <DeleteButton
          title="Eliminar"
          style="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg focus:ring-4 focus:outline-none focus:ring-red-300 bg-red-600 hover:bg-red-700 dark:focus:ring-red-800"
